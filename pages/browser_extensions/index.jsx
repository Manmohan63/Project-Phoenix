...
const index = () => {
  const data = [
    ...
    },
    {
      ...
      link: 'https://chrome.google.com/webstore/detail/cf-predictor/ocfloejijfhhkkdmheodbaanephbnfhn',
      image_address: 'https://lh3.googleusercontent.com/z7bUgnNFUF_3CBjOs4YijH8fdsgcZVw5CnrsEnyjMp2w3OqjwzocnCTt4MQJ0rm4z3tkVo0UUZcu8J9nzjs5aktT=w128-h128-e365-rj-sc0x00ffffff',
      desc: `This extension predicts rating changes for Codeforces. It shows approximate deltas during and after the contest. A huge number of your nerve cells die every time when you wait for a rating update on Codeforces.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias, sequi consectetur velit illum accusantium rerum commodi nam, eveniet, obcaecati consequuntur voluptatem. Sapiente vero ab, aut laborum natus deserunt dolor exercitationem ut soluta, maiores quos laboriosam dolorem voluptas ducimus facere recusandae? Mollitia ratione, aperiam facilis necessitatibus at nisi voluptates ipsum ducimus.`,
      version: `1.3.2`,
    },
    {
      name: 'CF-Predictor',
